...
/**
 * PaudPedia Design System — Tailwind Configuration
 *
 * Architecture:
 *   CSS custom properties (main.css :root) → Tailwind semantic tokens (this file)
 *
 * Color conventions:
 *   Brand scales:     text-primary-600, bg-secondary-500, ...
 *   Neutral semantic: bg-background, bg-surface, bg-surface-muted,
 *                     text-foreground, text-heading, text-body, text-muted,
 *                     border-default, border-muted
 *   Feedback scales:  text-success-600, bg-warning-100, text-danger-600, ...
 *
 * Never use raw gray-*, white, or black in templates. Always use semantic tokens.
 */
...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      /* ── Font Family ────────────────────────────────────────── */
      fontFamily: {
        sans: ['"Comic Relief"', 'system-ui', '-apple-system', 'sans-serif'],
      },
