...
Modul manajemen katalog memikul tanggung jawab besar dalam menata etalase produk pada ruang belanja digital, baik itu berupa kelas edukasi, tiket jadwal acara daring (Webinar), hingga produk fisik. Pemrograman untuk modul ini difokuskan pada upaya otomatisasi kalkulasi tampilan harga diskon coret, perumusan algoritma tingkat kepuasan materi, serta upaya perlindungan dini untuk menyensor data-data vital (seperti tautan rapat daring) agar tidak bocor pada antarmuka publik yang dapat diakses oleh pengunjung tanpa identitas.

4.8.1	Tampilan Antarmuka
Tampilan yang berkaitan dengan fitur ini meliputi:

- Screenshot Dasbor Manajemen Konten Kursus (Admin Panel) (/admin)
  Penjelasan: Tabel antarmuka bagi Moderator untuk mengelola seluruh produk *marketplace*. Dilengkapi dengan fitur *toggle* status untuk menerbitkan produk (Draft ke Published).
...
- Screenshot Formulir Buat/Edit Artikel (/admin/articles/create)
  Penjelasan: Antarmuka *WYSIWYG* (*What You See Is What You Get*) bagi redaktur untuk menulis dan memformat artikel berita secara dinamis beserta pengaturan meta URL (Slug).
...
- Screenshot Dasbor Analitik & Grafik Statistik Utama (/admin/analytics)
  Penjelasan: Panel kontrol terpusat bagi *Super Admin* yang menampilkan grafik kurva dan diagram untuk mengukur tren pendaftaran dan omset platform secara komprehensif.

- Screenshot Halaman Manajemen Pengguna (/admin/users)
  Penjelasan: Tabel *database* sentral untuk mengelola seluruh akun pengguna dari berbagai *tenant*. Admin memiliki akses untuk mengedit detail atau membekukan akun.

- Screenshot Halaman Manajemen Tenant Sekolah (/admin/schools)
  Penjelasan: Halaman untuk memantau pendaftaran sekolah klien (*tenant*), yang dilengkapi kontrol sakelar bagi admin untuk memperpanjang durasi langganan secara manual (*bypass*).

- Screenshot Halaman Laporan & Analitik Keuangan Penjualan (/admin/analytics) --= ini gaperlu karena dobel
  Penjelasan: Layar pelaporan khusus B2C yang memantau performa penjualan produk komersial, mendeteksi pesanan kedaluwarsa, dan menampilkan daftar produk terlaris.

- Screenshot Halaman Pengaturan Sistem (/admin/settings)
  Penjelasan: Antarmuka berpasangan (*key-value*) yang memungkinkan Super Admin untuk mengubah data statis eksternal situs (seperti nomor WA kontak layanan) tanpa harus mengedit kode HTML.
